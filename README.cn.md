...
![pet](https://repo.x-cmd.io/pet.svg?lang=zh)
...
合计: **3,098** 行代码（覆盖前 5 种语言、共 **38** 个文件）。
...
- **上游仓库**: <https://github.com/knqyf263/pet>
- **许可证**: MIT

## 发布

- **最新版本**: `v1.0.1` (2024-12-08)
- **最近提交**: 2026-03-13
- **Release 含资产**: 19 个

## 流行度

- **Star**: 5,346 · **Fork**: 249 · **开放 issue**: 144 · **贡献者**: 63

## 累计统计

- **发布数**: 28 · **已合并 PR**: 130 · **开放 PR**: 10 · **已关闭 issue**: 125 · **开放 issue**: 19 · **提交数**: 331
...
| 360d | 2025-09-16 | 0 | 1 | 4 | 0 | 1 | 3 |
| last720d | 2024-09-21 | 3 | 17 | 7 | 3 | 4 | 96 |
...
在 [repology.org](https://repology.org/project/pet) 上共有 **38** 个发行版报告此项目。**30** 个 ✅ 已是最新上游版本，**6** 个 ⚠️ 使用旧版本。
...
pet 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `pet` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/pet.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260911.yml` · 2026-09-11T19:41:27Z._
